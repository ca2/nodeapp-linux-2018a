...
extern int CLASS_DECL_VMSLNX AfxWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,
...
CLASS_DECL_VMSLNX WINBOOL AfxInitialize(WINBOOL bDLL, DWORD dwVersion)
{
