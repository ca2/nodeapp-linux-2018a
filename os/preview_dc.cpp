...
__STATIC long CLASS_DECL_VMSLNX _AfxMultMultDivDiv(
...
__STATIC int CLASS_DECL_VMSLNX _AfxComputeNextTab(int x, UINT nTabStops, LPINT lpnTabStops, int nTabOrigin, int nTabWidth)
{
   ENSURE(nTabWidth!=0);
...
HDC CLASS_DECL_VMSLNX AfxCreateDC(HGLOBAL hDevNames, HGLOBAL hDevMode)
{
   if (hDevNames == NULL)
      return NULL;
