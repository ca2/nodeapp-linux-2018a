...
/*WINBOOL CLASS_DECL_LNX AfxWinInit(HINSTANCE hInstance, HINSTANCE hPrevInstance,
...
UINT CLASS_DECL_LNX AfxGetFileName(const char * lpszPathName, __out_ecount_opt(nMax) LPTSTR lpszTitle, UINT nMax)
{
