...
/*WINBOOL CLASS_DECL_VMSLNX AfxWinInit(HINSTANCE hInstance, HINSTANCE hPrevInstance,
...
UINT CLASS_DECL_VMSLNX AfxGetFileName(const char * lpszPathName, __out_ecount_opt(nMax) LPTSTR lpszTitle, UINT nMax)
{
