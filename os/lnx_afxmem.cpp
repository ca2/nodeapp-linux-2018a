...
// Obsolete API
/*
void CLASS_DECL_lnx __set_alloc_stop(LONG lRequestNumber)
{
   _CrtSetBreakAlloc(lRequestNumber);
}
*/
#ifdef DEBUG
bool CLASS_DECL_lnx __check_memory()
...
bool CLASS_DECL_lnx __is_memory_block(const void * pData, UINT nBytes,
