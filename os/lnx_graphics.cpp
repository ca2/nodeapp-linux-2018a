...
/*      ASSERT(get_handle1() != NULL);
   ...
   bool graphics::fill_polygon(const POINTD * pa, int nCount)
   {
   ...
   bool graphics::fill_polygon(const POINT* pa, int nCount)
   {
   ...
   bool graphics::Polygon(const POINT* pa, int nCount)
   {
